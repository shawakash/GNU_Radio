...
class RC(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "RC", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("RC")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "RC")
        ...
        # Variables
        ##################################################
        self.bit_rate = bit_rate = 500000
        self.samp_rate = samp_rate = bit_rate*64
        self.EB = EB = 0.5
        ...
        self.qtgui_time_sink_x_0 = qtgui.time_sink_c(
            8192, #size
            samp_rate, #samp_rate
            'Raised Cosine waveform transmission', #name
            1, #number of inputs
            None # parent
        )
        ...
        self.qtgui_eye_sink_x_0.set_samp_per_symbol(30)
        ...
        self.interp_fir_filter_xxx_0_0 = filter.interp_fir_filter_ccf(1, rrc_taps/(samp_rate//bit_rate))
        self.interp_fir_filter_xxx_0_0.declare_sample_delay(0)
        self.interp_fir_filter_xxx_0 = filter.interp_fir_filter_ccf((samp_rate//bit_rate), rrc_taps)
        self.interp_fir_filter_xxx_0.declare_sample_delay(0)
        self.fir_filter_xxx_0 = filter.fir_filter_ccf((samp_rate//bit_rate), rrc_taps/(samp_rate//bit_rate))
        self.fir_filter_xxx_0.declare_sample_delay(0)
        self.digital_chunks_to_symbols_xx_0 = digital.chunks_to_symbols_ic(numpy.exp(1j*2*numpy.pi*numpy.arange(N)/N), 1)
        self.blocks_delay_0 = blocks.delay(gr.sizeof_gr_complex*1, 128)
        ...
        self.connect((self.interp_fir_filter_xxx_0_0, 0), (self.qtgui_eye_sink_x_0, 0))
        self.connect((self.interp_fir_filter_xxx_0_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.interp_fir_filter_xxx_0_0, 0), (self.qtgui_time_sink_x_0, 0))
    ...
    def set_bit_rate(self, bit_rate):
        ...
        self.set_samp_rate(self.bit_rate*64)
        self.fir_filter_xxx_0.set_taps(self.rrc_taps/(self.samp_rate//self.bit_rate))
        self.interp_fir_filter_xxx_0_0.set_taps(self.rrc_taps/(self.samp_rate//self.bit_rate))
...
def main(top_block_cls=RC, options=None):
